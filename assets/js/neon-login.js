...
;(function($, window, undefined)
{
	...
	$(document).ready(function()
	{
		...
		// Se carga una extension para los mensajes de Validator Jquery
		var head = document.getElementsByTagName('head')[0];
	    var script = document.createElement('script');
	    script.type = 'text/javascript';
	    script.src = "assets/js/messages_es.js";
			...
			submitHandler: function(ev)
			{
				...
				*/
				...
				setTimeout(function()
				{
					...
					$.ajax({
						url: baseurl + 'routes.php?c=user&a=controller&f=login',
						method: 'POST',
						dataType: 'json',
						data: {
						...
						error: function()
						{
							alert("Ha ocurrido un error de comunicación con la base de datos. Intente nuevamente.");
