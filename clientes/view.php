		...
		<h2>
			<div class="col-sm-6">Historial Cuentas por Cobrar</div>
			<div class="col-sm-6 text-right"><a href="routes.php?c=deudas&a=create" class="btn btn-primary" type="button">Agregar Cuenta por Cobrar</a></div>
		</h2>
		<br />
